...
*	Parents must sign a permission slip or waiver to acknowledge their student's participation in the program. We recommend that this permission form gets sent via email with the research consent form (see [IRB Requirements]) at least a week before the start of the summer program. Parents can sign and submit scanned copies of the form via email. Always have hard copies available on the first day of the program for parents to complete during student drop-off. 
    + An example waiver for UF youth summer programs can be found in *[Appendix A: Parent Student Waiver]*. 
...
*	Parents must complete a consent form for their students to participate in the study. We recommend that this research consent form gets sent via email with the permission form (see [Compliance]) at least a week before the start of the summer program. Parents can sign and submit scanned copies of the form via email. Always have hard copies available on the first day of the summer program for parents to complete during student drop-off.
    +	An example consent form can be found in *[Appendix B: Informed Consent]*
...
*	BBC Micro:bit V2 – one for each student
    ...
    +	[Purchase Micro:bits](https://www.parallax.com/product-category/microbit/mb-modules/){target="_blank"}
*	STEM Kit – Keyestudio 37-in-1 kit with the board is suggested
    +	One kit per 2 students is recommended
    + [Purchase STEM Kits](https://www.amazon.com/KEYESTUDIO-Sensors-Box-Starter-Micro/dp/B07GSVHWNS/ref=sr_1_2?keywords=keyestudio%2B37%2Bin%2B1%2Bmicro%2Bbit&qid=1638303507&sr=8-2&th=1){target="_blank"}
...
Follow the link to the How-To video playlist to view: [Goldberg Gator Engineering Explorers Summer Program How To Videos](https://youtube.com/playlist?list=PLFMIUy10MD1TAX1d60iok8QuqYkCnuLTL){target="_blank"}
...
[**Facilitator Training PowerPoint**](https://docs.google.com/presentation/d/1pa4Izo5BSVzyeRW1547sDR_SNkzzopTV/edit?usp=sharing&ouid=101837644018748928886&rtpof=true&sd=true){target="_blank"}

[**Facilitator Training Slide Guide**](https://drive.google.com/file/d/1hjUun7AijY_ld5hq3sJHjawil5kXs5eU/view?usp=sharing){target="_blank"}
...
[**4-Day Program Guide**](https://docs.google.com/document/d/1jYAA5klCv6t5kgX0rWaLUhFAMM7GCiTi/edit?usp=sharing&ouid=101837644018748928886&rtpof=true&sd=true){target="_blank"}

![](/Users/kristadulany/Documents/GitHub/GGEE/overview/4 day.jpg){width=500px}

[**5-Day Program Guide**](https://docs.google.com/document/d/12amkkHujozFgsCKLpXtIb6bFGUgHdUDq/edit?usp=sharing&ouid=101837644018748928886&rtpof=true&sd=true){target="_blank"}

![](/Users/kristadulany/Documents/GitHub/GGEE/overview/5 day.jpg){width=500px}

## Half Day Camps - 4 Hours

[**8-Day Program Guide**](https://docs.google.com/document/d/1xG_1E1HToyae9jNvOGlpWYFquy_16UiW/edit?usp=sharing&ouid=101837644018748928886&rtpof=true&sd=true){target="_blank"}

![](/Users/kristadulany/Documents/GitHub/GGEE/overview/8 day.jpg){width=500px}
...
[Teacher Activity Frameworks](https://docs.google.com/presentation/d/1cbmMQMF4CnW2sxQbw6LxZI148g5J6rVQ/edit?usp=sharing&ouid=101837644018748928886&rtpof=true&sd=true){target="_blank"}

**Student Frameworks**

[Student Activity Frameworks All Activities](https://docs.google.com/presentation/d/1gS8-U2K-2B4My0n30KcXEaDpcB8BNK8j/edit?usp=sharing&ouid=101837644018748928886&rtpof=true&sd=true){target="_blank"}

[Student Activity Frameworks: Programming Basics](https://docs.google.com/presentation/d/1Xnfftn2Rue4tNdWHirmjRXEd6C52i5LY/edit?usp=sharing&ouid=101837644018748928886&rtpof=true&sd=true){target="_blank"}

[Student Activity Frameworks: Coding Applications](https://docs.google.com/presentation/d/1g5dyGE7lguv5V7yYQjwdMBh5wxIuFS7p/edit?usp=sharing&ouid=101837644018748928886&rtpof=true&sd=true){target="_blank"}

[Student Activity Frameworks: Micro:bit Pet](https://docs.google.com/presentation/d/18KzoX_BgMHFRBj7n1AukolA_C5nu8AkN/edit?usp=sharing&ouid=101837644018748928886&rtpof=true&sd=true){target="_blank"}

[Student Activity Frameworks: Technical Design Challenge](https://docs.google.com/presentation/d/1TTCc2MwwXFT_jMkpBd-hDmQYDhvhP9yD/edit?usp=sharing&ouid=101837644018748928886&rtpof=true&sd=true){target="_blank"}
...
![](/Users/kristadulany/Documents/GitHub/GGEE/screenshots/Waiver 1.png){width=500px}
![](/Users/kristadulany/Documents/GitHub/GGEE/screenshots/Waiver 2.png){width=500px}
![](/Users/kristadulany/Documents/GitHub/GGEE/screenshots/Waiver 3.png){width=500px}

## Appendix B: Informed Consent

![](/Users/kristadulany/Documents/GitHub/GGEE/screenshots/Informed Consent 1.png){width=500px}
![](/Users/kristadulany/Documents/GitHub/GGEE/screenshots/Informed Consent 2.png){width=500px}
